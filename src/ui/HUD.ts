    ...
    root.innerHTML = `
      ...
      <div class="overlay">
        <section class="menu-panel" aria-label="Game menu">
          <h1>Scraft V3</h1>
          <p class="subtitle">Phase 5 — Items / Inventory / Crafting</p>
          <button class="primary" data-action="start">ゲーム開始 / 再開</button>
          <div class="controls">WASD 移動 / Space ジャンプ / Ctrl ダッシュ / Shift しゃがみ / 1〜9・ホイール Hotbar / E Inventory / 左長押し 破壊 / 右クリック 設置・Crafting Table / F3 デバッグ</div>
          <details>
            <summary>設定</summary>
